...
$router->post('/admin/organizations/activate', 'AdminController@activateOrganization');
$router->post('/admin/organizations/deactivate', 'AdminController@deactivateOrganization');
